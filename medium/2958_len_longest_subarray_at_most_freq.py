...
class TestMaxSubarrayLength(unittest.TestCase):
    ...
    def test_example_1(self):
        ...
        k = 2
        self.assertEqual(self.sol.maxSubarrayLength(nums, k), 6)

    def test_example_2(self):
        nums = [1, 2, 1, 2, 1, 2, 1, 2]
        k = 1
        self.assertEqual(self.sol.maxSubarrayLength(nums, k), 2)

    def test_example_3(self):
        nums = [5, 5, 5, 5, 5, 5, 5]
        k = 4
        self.assertEqual(self.sol.maxSubarrayLength(nums, k), 4)
